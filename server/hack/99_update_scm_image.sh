...
kubectl set image deployment/spi-scm-file-retriever-server server=quay.io/redhat-appstudio/service-provider-integration-scm-file-retriever-server':'$SPIS_TAG_NAME -n spi-scm
