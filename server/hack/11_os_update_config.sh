...
SCM_HOST_VALUE='scm.'$(oc get ingresses.config/cluster -o jsonpath={.spec.domain})'.nip.io'
OAUTH_URL='oauth.'$( oc get ingresses.config/cluster -o jsonpath={.spec.domain})'.nip.io'
